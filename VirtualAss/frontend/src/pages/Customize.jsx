...
function Customize() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-black to-[#0486cc] flex justify-center items-center flex-col p-[20px] relative'>
